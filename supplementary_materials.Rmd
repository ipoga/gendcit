...
rt.final %>%
  kable(digits = 2, col.names = c("Outcome","Model","Predictor","Estimate","Std. Error","EE","EE.LCL","EE.UCL","Estimate","Std. Error","EE","EE.LCL","EE.UCL")) %>%
  kable_styling(bootstrap_options = c("striped", "hover","condensed")) %>%
...
## Standardized Tweedie regression results
