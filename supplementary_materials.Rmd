...
rt.final %>%
  kable(digits = 2, col.names = c("Outcome","Model","Predictor","Estimate","Std. Error","EE","EE.LCL","EE.UCL","Estimate","Std. Error","EE","EE.LCL","EE.UCL"),caption = "**Supplementary Table S4. Tweedie regression results") %>%
